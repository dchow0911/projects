...
- [Project Link](## Featured Projects
#### Unveiling Real Estate Trends with Data Visualization & Infographics in Power BI
- Used Power BI to analyze real estate trends, focusing on a 187-day closing duration, and proposed strategies to reduce transaction costs by 20% and optimize deal closure times through predictive analytics.
...
- Led the development of engaging Tableau dashboards to analyze and enhance India-Canada commodity exports, providing insights and recommendations to boost trade volumes and strengthen bilateral relations.
...
- Spearheaded the development of an NLP-based project to optimize recruitment processes with features like resume summarization, ATS scoring, and job role matching, enhancing efficiency for HR professionals and job seekers.
...
- Developed an advanced search functionality for Flipkart to enhance user experience by improving relevance, recommending similar products, and driving cross-selling, boosting engagement and sales conversion rates.
...
- Implemented Exploratory Data Analysis (EDA) for bank defaults using Python and CRISP-DM methodology to identify patterns, mitigate risks, and support informed decision-making in the banking sector.
...
- Implemented predictive analytics in R to forecast airfare prices using various flight factors, generating insights for business optimization and improved decision-making.
...
- Developed an AI-powered mobile app using CNNs and deep learning to predict dog emotions and needs, including hunger and discomfort, leveraging computer vision and advanced AI methodologies.
...
- Led the development of a mobile healthcare app with a robust MySQL backend, offering users detailed information on hospitals based on medical needs, proximity, and facilities.
...
- Led the digitalization of business operations by creating operational dashboards and automating processes using advanced Microsoft Excel techniques to enhance efficiency and decision-making.
...
- Led a comprehensive audit to enhance iYogi's brand relationship with customers through strategic initiatives, including technical improvements, community engagement, and personalized AI guidance, while emphasizing core values of mind-body harmony and innovation.
...
- Led a quantitative study using data analysis and machine learning to explore the causal relationship between ticket prices and consumer churn in the airline industry, optimizing pricing strategies to improve customer retention.
...
- Analyzed consumer purchasing patterns using econometric techniques to understand the impact of demographics, socioeconomic factors, and other variables on purchase decisions, providing insights for targeted marketing, product development, and sales optimization.
...
- Compared five regression techniques—including Multiple Linear Regression, Ridge, Lasso, Elastic Net, and Poisson Regression—using RMSE and R-squared to evaluate their performance in predicting sales, with Poisson Regression emerging as the most effective due to its suitability for modeling rare events and providing insights into sales variability.
- [GitHub Repo Link](https://github.com/dchow0911/projects/blob/main/Advanced%20Data%20Analysis.Rmd)

#### Nike Air into the Metaverse
- Developed a data-driven marketing strategy to introduce Nike Air into the Metaverse, utilizing advanced marketing techniques and comprehensive analysis to maximize market impact and engagement.
...
- Conducted an analysis of Cipla's international business strategies and competitive advantages, leveraging data analysis and BI to evaluate its global market penetration, financial performance, and R&D investments.
...
- Delivered presentations on CEO-board relations and dismissal models using real-world examples and data-driven analysis, showcasing strong analytical and communication skills.
